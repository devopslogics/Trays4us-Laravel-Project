        ...
        <div class="tfu-artwork-slider-handler" >
                ...
                <div class="row tfu-slider-artwork-handler">
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="licence_author_content">
                            <a href="{{ route('artist-detail',['id' =>$artist->id ]) }}">
            ...
            @if ($artist->products->isNotEmpty())
                <div class="tfu-slider-position">
                    ...
                    <button class="custom-prev-arrow-artwork"><img src="{{ asset('/assets/frontend-assets/svg/left-arrow.svg') }}"  /></button>
                    <button class="custom-next-arrow-artwork"><img src="{{ asset('/assets/frontend-assets/svg/right-arrow.svg') }}"  /></button>
                </div>
            @endif
        </div>
    @endforeach
