            ...
            <div class="page-header">
                ...
                <div class="card">
                    <div class="ftu-mass-upload card-body">
                        ...
                        <form action="<?php echo e(route('add-product-submitted')); ?>" method="post" enctype="multipart/form-data" class="ftu-form-user-uploaded dropzone" id="mass_upload_save">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="badge" id="badge">
                                                ...
                                                <?php $__currentLoopData = $badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($badge->id); ?>" data-custom="<?php echo e($badge->custom); ?>"><?php echo e($badge->badge); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(function() {
            ...
            var myDropzone = new Dropzone("#dropzoneDragArea", {
                ...
                url: "<?php echo e(route('mass-upload-save')); ?>",
            ...
            $("#mass_upload_save_btn").click(function(event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('create-product-from-mass-upload')); ?>",
                    method:"POST",
                    data:{
...
<?php echo $__env->make('layouts.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/admin/products/mass-upload.blade.php ENDPATH**/ ?>