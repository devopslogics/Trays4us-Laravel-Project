...
<html lang="en">
   <head>
       ...
       <?php echo $__env->yieldPushContent('structured_data_markup'); ?>
   </head>
   <body class="tfu-current-<?php echo e(Route::currentRouteName()); ?>">

   <div id="tfu_loading" style="display: none; background-color: #0003;">
       <img id="loading-image" src="<?php echo e(asset('assets/images/ajax_loader_red.gif')); ?>" alt="Loading..." style="width: 50px; height: 50px;      position: absolute;  left:47.6%;   top: 50%;"/>
...
<?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/layouts/frontend.blade.php ENDPATH**/ ?>