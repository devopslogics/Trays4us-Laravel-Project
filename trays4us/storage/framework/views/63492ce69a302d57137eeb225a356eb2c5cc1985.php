        ...
        <div class="login-body container">
            <div class="loginbox">
                <div class="login-right-wrap">
                    ...
                    <form action="<?php echo e(route('admin_verify2fa_post')); ?>" method="POST">
                        ...
                        <?php if($errors->has('2fa_code')): ?>
                            <span class="text-danger"><?php echo e($errors->first('2fa_code')); ?></span>
                        <?php endif; ?>
...
<?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/admin/users/verify-2fa.blade.php ENDPATH**/ ?>