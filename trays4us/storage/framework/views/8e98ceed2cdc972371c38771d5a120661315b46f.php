...
<div class="full-page-image">
    <img src="<?php echo e($sourcePath); ?>" alt="Artist Logo">
</div>

<div style="page-break-after: always;"></div>

<div class="content" style=" padding: 0px 0px; position: relative;  " >
  <div style=" width:<?php echo e($product_type->logo_width_print); ?>px; height:<?php echo e($product_type->logo_height_print); ?>px;
        margin: 0 auto; top: 50%;     position: absolute; left: 50%;
    transform: translate(-50%, -50%);
  " >
    <img src="<?php echo e($customer_logo); ?>"
     style="position: absolute;
            ...
            max-width: 100%;
            max-height: 100%;
            <?php echo $img_style; ?> /* Apply the dynamic width or height */
            vertical-align: middle;"
     alt="Artist Logo">
  </div>
  <?php if($product_type->fx == 1): ?>

    <div  style="position: absolute; left:50%; transform: translate(-50%, -50%); bottom:<?php echo e($product_type->care_instructions_top); ?>px;  margin: <?php echo e($product_type->parent_div_margin); ?>; " >
        <img src="<?php echo e($care_instruction); ?>" style="position: absolute;   height: auto; <?php echo e(($product_type->care_instruction_width) ? 'width:'.$product_type->care_instruction_width : ''); ?>px ; max-height: auto;" alt="">
	</div>
    <?php endif; ?>
</div>
...
<?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/admin/products/custom-product-pdf.blade.php ENDPATH**/ ?>