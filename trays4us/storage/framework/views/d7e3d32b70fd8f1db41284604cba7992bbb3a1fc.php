        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('add-product-submitted')); ?>" method="post" enctype="multipart/form-data" name="add_product" id="add_product_form" class="add_product dropzone">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="product_name" value="<?php echo old('product_name'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>SKU</label>
                                    <input type="text" class="form-control"  name="product_sku" value="<?php echo e(old('product_sku')); ?>">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="parent_product_type" id="parent_product_type">
                                        ...
                                        <?php $__currentLoopData = $parent_product_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent_product_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($parent_product_type->id); ?>" <?php echo e(old('parent_product_type') == $parent_product_type->id ? 'selected' : ''); ?>><?php echo e($parent_product_type->type_name); ?></option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="case_pack" id="case_pack" value="<?php echo e(old('case_pack')); ?>" readonly>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="design_type" id="product_customizable">
                                        ...
                                        <?php $__currentLoopData = $customizables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customizable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($customizable->id); ?>" <?php echo e(old('product_customizable', $customizable->defulat == 1) == $customizable->id ? 'selected' : ''); ?>><?php echo e($customizable->customizable_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="minimum_order_quantity" id="minimum_order_quantity" value="<?php echo e(old('minimum_order_quantity')); ?>" readonly>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="badge" id="badge">
                                        ...
                                        <?php $__currentLoopData = $badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($badge->id); ?>" data-custom="<?php echo e($badge->custom); ?>" <?php echo e(old('badge') == $badge->id ? 'selected' : ''); ?>><?php echo e($badge->badge); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="style_id">
                                        ...
                                        <?php $__currentLoopData = $themes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($theme->id); ?>" <?php echo e(old('style_id') == $theme->id ? 'selected' : ''); ?>><?php echo e($theme->style_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="country_id" id="country_id">
                                        ...
                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($country->id); ?>" <?php echo e(old('country_id') == $country->id ? 'selected' : ''); ?>><?php echo e($country->country_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="custom_editor" rows="4" cols="50"><?php echo e(old('description')); ?></textarea>
                                </div>
                            </div>
            ...
            function get_state_by_country_id(country_id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var selectedCity = '<?php echo e(old('state_id')); ?>';
...
<?php echo $__env->make('layouts.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/admin/products/add.blade.php ENDPATH**/ ?>