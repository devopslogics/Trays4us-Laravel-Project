<?php $__env->startPush('styles'); ?>
    ...
    <style>
        ...
        .rounded_image_outer .edit_first_section .cropper-face:before
        {
            ...
            background-image: url(<?php echo e(asset('/assets/frontend-assets/images/rounded-image-li-border.png')); ?>);
            opacity: 0.9;
        }
        .tray-type-1612 .edit_first_section .cropper-face:before
        {
            ...
            width: 100%;
            background-size: cover;
            background-image: url(<?php echo e(asset('/assets/frontend-assets/images/1612-border.png')); ?>);
            opacity: 0.9;
        }
        .tray-type-4x4 .edit_first_section .cropper-face:before
        {
            ...
            width: 100%;
            background-size: cover;
            background-image: url(<?php echo e(asset('/assets/frontend-assets/images/4x4-border.png')); ?>);
            opacity: 0.9;
        }
        .tray-type-1105 .edit_first_section .cropper-face:before
        {
            ...
            width: 100%;
            background-size: cover;
            background-image: url(<?php echo e(asset('/assets/frontend-assets/images/1105-border.png')); ?>);
            opacity: 0.9;
        }
        .tray-type-1108 .edit_first_section .cropper-face:before
        {
            ...
            width: 100%;
            background-size: cover;
            background-image: url(<?php echo e(asset('/assets/frontend-assets/images/1108-border.png')); ?>);
            opacity: 0.9;
        }
        .ui-widget-content {
    background: #00bb1e;
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="tfu-license-artwork-wrapper">
        <div class="container-fluid p-0">
            ...
            <form action="<?php echo e(route('save-edit-product')); ?>" method="post" enctype="multipart/form-data" name="save_edit_product" id="save_edit_product">
                <?php echo csrf_field(); ?>
                <input type="hidden" value="<?php echo e($temp_product->id); ?>" id="product_id">
                  <div class="row artist_images_row preview_artist edit_items_row align-items-start <?php echo e($html_class); ?>_outer <?php echo e($tray_type_html_class); ?>">

                    <div class="col-12 tfu-edit-section-crop">
                        <div class="edit_first_section">
                            <div class="edit_image_conntainer" id="edit_image_container" style="width: <?php echo e($width); ?>px;height: <?php echo e($height); ?>px">
                                <img src="<?php echo e(url('uploads/customizer-products/'.$temp_product->fetaure_image_orginal_name)); ?>" data-image-name="<?php echo e($temp_product->feature_image); ?>" id="custom_edit_image" alt="" class="<?php echo e($html_class); ?> <?php echo e($tray_type_html_class); ?> w-100">
                            </div>
                            <div class="zoom_in_out">
                                <div class="zoom_feature">
                                    <span class="zoom_in" id="zoom-in"><img src="<?php echo e(asset('/assets/images/zoom_in.svg')); ?>" alt=""></span>
                                    <canvas id="canvas" style="display: none;"></canvas>
                                </div>
                                <div class="zoom_persent"><span id="zoom-percentage" style="<?php echo e($zoomPercentStyles); ?>"><?php echo e(round($scalePercent)); ?>%</span></div>
                                <div class="zoom_feature">
                                    <span class="zoom_out" id="zoom-out"><img src="<?php echo e(asset('/assets/images/zoom_out.svg')); ?>" alt=""></span>
                                    <canvas id="canvas" style="display: none;"></canvas>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="mt-2 image-resolutions list-unstyled p-0">
                            <li class="m-0 p-0 d-flex gap-4 text-black">
                                <span class="edit_image_reso" ><?php echo e($getProductTypeDetail->child->width); ?> x <?php echo e($getProductTypeDetail->child->height); ?> px</span>
                                <span><?php echo e($getProductTypeDetail->child->type_name); ?> <?php echo e($getProductTypeDetail->type_name); ?></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-12 col-lg-6 edit_second_section ">
                        <h2 class="title_edit_image"><?php echo e($temp_product->product_name ?? ''); ?></h2>
                        <h3 class="edit_sub_title"><?php echo e($getProductTypeDetail->child->type_name ?? ''); ?> <?php echo e($getProductTypeDetail->type_name ?? ''); ?></h3>
                        <div class="edit_image_price">
                            <p>$<?php echo e($temp_product->price ?? ''); ?><span> <?php echo e((isset($site_management->msrp_price) && $site_management->msrp_price > 0 ) ? 'MSRP $'.number_format(ceil($site_management->msrp_price * $temp_product->price),2)  : ''); ?></span></p>
                        </div>
                        <ul class="order_details_edit_image list-unstyled p-0">
                            <li>Minimum Order <?php echo e((isset($moq_case_pack->minimum_order_quantity) && $moq_case_pack->minimum_order_quantity > 0) ? $moq_case_pack->minimum_order_quantity  : 1); ?></li>
                            <li>Case Pack of <?php echo e((isset($moq_case_pack->case_pack) && $moq_case_pack->case_pack > 0) ? $moq_case_pack->case_pack  : 1); ?></li>
                        </ul>
                        <?php if($getProductTypeDetail->child->fx == 1): ?>
                            <div class="edit_logo_image tfu_custom_artist_logo">
                                <img src="<?php echo e(asset('/assets/images/'.$getProductTypeDetail->child->tray_blank_image)); ?>" alt="">
                                <div class="logo-preview">
                                    <img src="<?php echo e(url('uploads/users/'.$customer->customer_logo)); ?>" style="max-width: <?php echo e($logo_width); ?>px" class="tfu_artist_logo_on_tray" alt="">
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="edit_logo_image tfu_custom_artist_logo">
                                <img src="<?php echo e(url('uploads/customizer-products/customer-'.$temp_product->crop_image)); ?>" alt="">
                            </div>
                        <?php endif; ?>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="row  border-dark pt-3 pb-5 d-flex justify-content-between  button_section gap-2">
                        ...
                        <div class="col-12 col-sm-6  col-lg-5 col-xl-4 d-flex gap-4 justify-content-between justify-content-lg-end">
                            <a href="<?php echo e(route('preview-your-work')); ?>" class="btn btn-secondary w-100" id="edit_cancel">Cancel</a>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            var zoomLevel = 1;
            const optimalWidth = <?php echo e($getProductTypeDetail->child->width); ?>;
            const optimalHeight = <?php echo e($getProductTypeDetail->child->height); ?>;
            originalZoom = <?php echo e($scalePercent); ?>; // Initial value
            currentZoom = originalZoom; // Current zoom percentage
            let slideValGlobal = 1;
            let previousSlideVal = 1;
            var cropper = new Cropper(image, {
               // aspectRatio: <?php echo e($getProductTypeDetail->child->width/$getProductTypeDetail->child->height); ?>,
                viewMode: 3,
                autoCropArea: 1,
                minCropBoxWidth: <?php echo e($getProductTypeDetail->child->width); ?>,
                minCropBoxHeight: <?php echo e($getProductTypeDetail->child->height); ?>,
                autoCrop: true,
                ready: function () {
                    croppable = true;
                },
            ...
            button.onclick = function () {
                ...
                croppedCanvas = cropper.getCroppedCanvas({
                    width: <?php echo e($getProductTypeDetail->child->width); ?>,
                    height: <?php echo e($getProductTypeDetail->child->height); ?>
                ...
                canvas.toBlob(function(blob) {
                    ...
                    reader.onloadend = function() {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('save-edit-product')); ?>',
                            method: 'POST',
                            data: {
                                image: base64data,
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/frontend/artist/edit-product.blade.php ENDPATH**/ ?>