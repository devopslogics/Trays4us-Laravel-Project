...
<?php $__env->startPush('structured_data_markup'); ?>
    <script type="application/ld+json">{
          ...
          "url": "<?php echo e(route('contact-us')); ?>",
          "logo": "<?php echo e(url('uploads/users/'.$site_management->website_logo)); ?>",
          "foundingDate": "2012",
          "location": {
            "@type": "Place",
            "address": {
          ...
          "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "<?php echo e(route('contact-us')); ?>",
            "breadcrumb": {
              "@type": "BreadcrumbList",
              "itemListElement": [
                 {
                 ...
                 },
                {
                  ...
                  "position": 2,
                  "name": "Contact Us",
                  "item": "<?php echo e(route('contact-us')); ?>"
                }
              ]
            }
          }
     ...
     <div  class="row" >
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" >
        <div class="tfu-contact-company-image" >
          <img src="<?php echo e(asset('/assets/frontend-assets/svg/Logo Trays4Us.svg')); ?>" alt="Logo Trays4Us.svg"  />
        </div>
     </div>
          ...
          <div class="row" >
              ...
              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-1 tfu-cf" >
                <div class="tfu-discover-image" >
                  <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean9.jpg')); ?>" alt="2023_LLBean9.jpg"  />
                </div>
              </div>

              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-2 tfu-cf" >
                <div class="tfu-discover-image" >
                  <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean10.jpg')); ?>" alt="2023_LLBean10.jpg" />
                </div>
              </div>

              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-3 tfu-cf" >
                <div class="tfu-discover-image" >
                  <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean11.jpg')); ?>" alt="2023_LLBean11.jpg" />
                </div>
              </div>

              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-4 tfu-cf" >
                <div class="tfu-discover-image" >
                  <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_SaraFitz_Instagram.jpg')); ?>" alt="2023_SaraFitz_Instagram.jpg" />
                </div>
              </div>

              <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-6 df-5 tfu-cf" >
                <div class="tfu-discover-image" >
                  <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean.jpg')); ?>" alt="2023_LLBean.jpg" />
               </div>
              </div>

              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-6 tfu-cf " >
               <div class="tfu-discover-image" >
                  <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean12.jpg')); ?>" alt="2023_LLBean12.jpg" />
                </div>
              </div>

              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-7 tfu-cf" >
                <div class="tfu-discover-image" >
                  <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean2.jpg')); ?>" alt="2023_LLBean2.jpg" />
                </div>
              </div>
              ...
              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-8 tfu-cf" >
                  <div class="tfu-discover-image" >
                      <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean3.jpg')); ?>" alt="2023_LLBean3.jpg" />
                  </div>
              </div>

              <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-6 df-9 tfu-cf" >
                  <div class="tfu-discover-image" >
                      <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean5.jpg')); ?>" alt="2023_LLBean5.jpg" />
                    </div>
              </div>

              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-10 tfu-cf" >
                  <div class="tfu-discover-image" >
                      <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean4.jpg')); ?>" alt="2023_LLBean4.jpg" />
                    </div>
              </div>
              ...
              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-11 tfu-cf" >
                  <div class="tfu-discover-image" >
                      <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean8.jpg')); ?>"  alt="2023_LLBean8.jpg"/>
                    </div>
              </div>

              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-12 tfu-cf" >
                 <div class="tfu-discover-image" >
                      <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean6.jpg')); ?>" alt="2023_LLBean6.jpg"/>
                  </div>
              </div>

              <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3 df-13 tfu-cf" >
                <div class="tfu-discover-image" >
                  <img src="<?php echo e(asset('/assets/frontend-assets/images/2023_LLBean7.jpg')); ?>" alt="2023_LLBean7.jpg"/>
                </div>
              </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/frontend/site/contact-us.blade.php ENDPATH**/ ?>