  ...
  <div class="container-fluid">
    ...
    <div class=" tfu-general-breadcumb-wrapper" >
        ...
        <ul class="shop-breadcrumb">
            ...
            <li><a href="<?php echo e(route('frontend.products')); ?>">Products</a></li>
   ...
   <div class="row" >
    ...
    <div class="col-12 col-sm-6  col-md-6 col-lg-1 col-xl-1 ftu-p-3" >
        <div class="tfu-product-details-gallery <?php echo e(count($product_galleries) > 4 ? 'tfu_gallery_scroll' : ''); ?> " >
            <div class="tfu-slider-nav">
                <?php if($product_galleries->isNotEmpty()): ?>
                    <?php $__currentLoopData = $product_galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div><div class="tfu-product-slider-image-handler" ><img src="<?php echo e(url('uploads/products/large-'.$product_gallery->image_name)); ?>" alt="<?php echo e($product->product_name ?? ''); ?>" /></div></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                    <div><div class="tfu-product-image-handler" ><img src="<?php echo e(url('uploads/products/large-'.$product->feature_image)); ?>" alt="<?php echo e($product->product_name ?? ''); ?>" /></div></div>
                <?php endif; ?>
     ...
     <div class="col-12 col-sm-6 col-md-6 col-lg-4  col-xl-4 ftu-p-1" >
        ...
        <div class="tfu-card-header">
            <?php if($product->badge && $product->color): ?>
                <div class="tfu-card-product-ribbon"  >
                    <div class="tfu-ribbon tfu-ribbon-top-left"><span style = "background:<?php echo e($product->color); ?>;" ><?php echo e($product->badge); ?></div>
                </div>
            <?php endif; ?>
         ...
         <div class=" tfu-slider-single">
            <?php if($product_galleries->isNotEmpty()): ?>
                <?php $__currentLoopData = $product_galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div><div class="tfu-product-image-handler" ><img src="<?php echo e(url('uploads/products/large-'.$product_gallery->image_name)); ?>" alt="<?php echo e($product->product_name ?? ''); ?>" /></div></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="tfu-card-img-overlay d-flex justify-content-end">
            <div class="tfu-dropdown">
                ...
                <ul class="tfu-dropdown-menu">
                    <li><a href="javascript:void(0)"  rel="nofollow" class="tfu_delete_custom_product tfu_single_delete" data-pid="<?php echo e($product->pid); ?>">Delete</a></li>
                    <?php /*
                    <li>Copy</li>
                    <li>Edit</li>
                    <li>Make Public</li>
       ...
       <div class="col-12 col-sm-6  col-md-6 col-lg-7  col-xl-7 ftu-p-2" id="product_<?php echo e($product->pid); ?>">
        <div class="tfu-shop-content-handler tfu_product_qty_wrapper">
            ...
            <div class="tfu-shop-details-product-info">
                ...
                <a href="<?php echo e(route('artist-detail',['slug' => $product->artist_slug ])); ?>" class="tfu_artist_name" style="color: #000"><p> <?php echo $product->display_name; ?></p></a>
                <h1> <?php echo $product->product_name; ?> by <?php echo $product->display_name; ?>

                    <br>
                    <?php echo e($getProductTypeDetail->child->type_name ?? ''); ?>

                    <?php echo e($getProductTypeDetail->type_name ?? ''); ?>
            ...
            <div class="tfu-shop-details-product-price" >
                <?php if(Session::has('is_customer') && !empty(Session::get('is_customer'))): ?>
                 <h2>$<?php echo e($product->price); ?> <span><?php echo e((isset($site_management->msrp_price) && $site_management->msrp_price > 0 ) ? 'MSRP $'.number_format(ceil($site_management->msrp_price * $product->price),2)  : ''); ?></span></h2>
                <?php else: ?>
                 <h3><?php echo e((isset($site_management->msrp_price) && $site_management->msrp_price > 0 ) ? 'MSRP $'.number_format(ceil($site_management->msrp_price * $product->price),2)  : ''); ?></h3>
                <?php endif; ?>
            </div>

            <div class="tfu-shop-details-order-pack"   >
                <p>Minimum Order <?php echo e((isset($moq_case_pack->minimum_order_quantity) && $moq_case_pack->minimum_order_quantity > 0) ? $moq_case_pack->minimum_order_quantity  : 1); ?> </p>
                <p>Case Pack of <?php echo e((isset($moq_case_pack->case_pack) && $moq_case_pack->case_pack > 0) ? $moq_case_pack->case_pack  : 1); ?></p>
            </div>

            <div class="tfu-shop-details-shipping"   >
                <p>Free shipping for orders $<?php echo e($site_management->shipping_threshold); ?>+</p>
               ...
               <div class="ftu-wrapper-select-quantity">
                   ...
                   ?>
                    ...
                    <div class="ftu-select-btn-qty">
                        <span data-qty="<?php echo e($selected_quantity); ?>"><?php echo e($selected_quantity); ?>  ($<?php echo e($calculted_price); ?>)</span>
                    ...
                    <div class="ftu-select-content-qty">
                        ...
                        <ul class="ftu-qty-options">
                            <?php
                                ...
                                ?>
                                <li onclick="updateName(this)" data-qty="<?php echo e($quantity); ?>" ><?php echo e($quantity); ?>  ($<?php echo e($calculated_price2); ?>)</li>
                                <?php
                        ...
                        <div class="ftu-qty-input">
                            <input spellcheck="false" data-moq="<?php echo e($p_quantity); ?>" data-cp="<?php echo e($moq_case_pack->case_pack); ?>"  data-price="<?php echo e($product->price); ?>" class="ftu-product-quantity numeric_only" type="text" placeholder="Custom quantity">
                         </div>
                    </div>
                ...
                <div class="tfu-add-to-cart-btn">
                    <a href="javascript:void(0)"  rel="nofollow" data-pid="<?php echo e($product->pid); ?>" class="single_add_to_cart"><?php echo $add_to_cart_string; ?></a>
                </div>
                <span class="already_item_cart"><?php echo e($already_in_cart_item_str); ?></span>
               </div>
            ...
            <div class="tfu-sign-in-product-wrapper">
                <a  href="<?php echo e(route('sign-in')); ?>" class="tfu-sign-in-product-info">Register / Sign In</a>
            </div>
            <?php endif; ?>
       </div>
   </div>
    ...
    <div class="col-12 col-sm-12  col-md-12 col-lg-12 col-xl-12" >
       <div class="accordion" id="tfuaccordionExample">
           <div class="accordion-item">
               <?php if($description = $getProductTypeDetail->child->type_description ?? $getProductTypeDetail->type_description): ?>
                 ...
                 <div  class="tfu-product-specifications-wrapper" >
                   ...
                   ?>
                     <div class="tfu-product-image-spec " >
                        <?php if(!empty($typeImage) && \Storage::disk('uploads')->exists('/products/' . $typeImage)): ?>
                            <img src="<?php echo e(url('uploads/products/'.$typeImage)); ?>" alt="<?php echo e($typeImage); ?>" >
                        <?php endif; ?>
                     </div>
                   </div>
               </div>
                ...
                <div class="tfu-product-design-slide-list">
                    <?php $__currentLoopData = $related_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="tfu-product-design-img">
                            <a href="<?php echo e(route('product-detail',['slug' => $related_product->product_slug ])); ?>">
                                <img src="<?php echo e(url('uploads/products/small-'.$related_product->feature_image)); ?>" alt="<?php echo e($related_product->product_name); ?>" />
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <?php if($product_by_artists->isNotEmpty()): ?>
                ...
                <div class="row load_product_row">
                        <?php $__currentLoopData = $product_by_artists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-lg-3 col-sm-4  col-6 product_wrapper" data-pid="<?php echo e($product->pid); ?>" id="product_<?php echo e($product->pid); ?>">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/frontend/shop/product-detail.blade.php ENDPATH**/ ?>