        ...
        <section class="tfu-hero-slider-wrapper" >
            ...
            <div class="tfu-slick-carousel">
                <?php $__currentLoopData = $homepage_sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $homepage_slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if( !empty($homepage_slider->slider_image) && \Storage::disk('uploads')->exists('/sliders/' . $homepage_slider->slider_image)): ?>


                        <div data-url="<?php echo e($homepage_slider->entire_banner_link ?? ''); ?>" class="<?php echo e(!empty($homepage_slider->entire_banner_link) ? 'entire_banner_link' : ''); ?>" style="background-image: url('<?php echo e(url('uploads/sliders/'.$homepage_slider->slider_image)); ?>');   background-size: cover; background-repeat: no-repeat; background-position: center center; " >
                             <div class="tfu-slider-content-cover">

                                <div class="tfu-slide-aligment" style="justify-content: <?php echo e($homepage_slider->slider_direction); ?>;">
                                <div class="tfu-slide-content">
                                    <?php if($homepage_slider->slider_title_visibility == 1): ?>
                                        <?php if($key === 0): ?>
                                            <p style="font-size:<?php echo e($homepage_slider->title_size.'px'); ?>; background-color: <?php echo e($homepage_slider->title_box_color ? $homepage_slider->title_box_color :  'initial'); ?>;">
                                                <a href="<?php echo e($homepage_slider->slider_title_link ?? 'javascript:void(0)'); ?>" style="color: <?php echo e($homepage_slider->title_color); ?>; text-decoration: none;" rel="nofollow"><?php echo e($homepage_slider->slider_title); ?></a>
                                            </p>
                                        <?php else: ?>
                                            <p style="font-size:<?php echo e($homepage_slider->title_size.'px'); ?>; background-color: <?php echo e($homepage_slider->title_box_color ? $homepage_slider->title_box_color :  'initial'); ?>;">
                                                <a href="<?php echo e($homepage_slider->slider_title_link ?? 'javascript:void(0)'); ?>" style="color: <?php echo e($homepage_slider->title_color); ?>; text-decoration: none;" rel="nofollow"><?php echo e($homepage_slider->slider_title); ?></a>
                                    ...
                                    <?php if($homepage_slider->shop_now_link && $homepage_slider->shop_btn_text): ?>
                                        <button class="tfu-shop-now" > <a href="<?php echo e($homepage_slider->shop_now_link); ?>" > <?php echo e($homepage_slider->shop_btn_text); ?> </a></button>
                                    <?php endif; ?>

                                    <ul class="tfu-breadcumb-slider-home" style="padding: 8px 20px; background-color: <?php echo e($homepage_slider->label_box_color ? $homepage_slider->label_box_color :  'transparent'); ?>;">

                                        <?php if($homepage_slider->first_label && $homepage_slider->first_link): ?>
                                            <li><a href="<?php echo e($homepage_slider->first_link); ?>" style="color: <?php echo e($homepage_slider->label_color); ?> !important;font-size:<?php echo e($homepage_slider->label_text_size); ?>px"><?php echo e($homepage_slider->first_label); ?></a></li>
                                        <?php endif; ?>

                                        <?php if($homepage_slider->second_label && $homepage_slider->second_link): ?>
                                            <li><a href="<?php echo e($homepage_slider->second_link); ?>"  style="color:<?php echo e($homepage_slider->label_color); ?> !important;font-size:<?php echo e($homepage_slider->label_text_size); ?>px"><?php echo e($homepage_slider->second_label); ?></a></li>
                                       <?php endif; ?>

                                       <?php if($homepage_slider->third_label && $homepage_slider->third_link): ?>
                                            <li><a href="<?php echo e($homepage_slider->third_link); ?>"  style="color:<?php echo e($homepage_slider->label_color); ?> !important;font-size:<?php echo e($homepage_slider->label_text_size); ?>px"><?php echo e($homepage_slider->third_label); ?></a></li>
                                       <?php endif; ?>
            ...
            <button class="custom-prev-arrow"><img src="<?php echo e(asset('/assets/frontend-assets/svg/left-arrow.svg')); ?>" alt="left-arrow.svg" /></button>
            <button class="custom-next-arrow"><img src="<?php echo e(asset('/assets/frontend-assets/svg/right-arrow.svg')); ?>"  alt="right-arrow" /></button>
        </section>
    <?php endif; ?>
    <?php /*
...
<section>
    <div class="tfu-shop-wrapper-btn">
        <h1 style="font-size: 18px;"><a href="<?php echo e(route('frontend.products')); ?>" >View All Designs</a></h1>
    </div>
</section>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        var ENDPOINT = "<?php echo e(route('ajax-home-more-products')); ?>";
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/frontend/site/home.blade.php ENDPATH**/ ?>