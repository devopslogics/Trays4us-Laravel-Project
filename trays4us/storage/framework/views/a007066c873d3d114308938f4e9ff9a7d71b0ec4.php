...
<?php $__env->startSection('content'); ?>
    <?php if($cart_products->isNotEmpty()): ?>
        ...
        <form method="post" id="cart_form">
            ...
            <div class="row  tfu-dashboard-handler" >
                ...
                <ul class="tfu-dashboard-menu-link">
                    ...
                    <span><svg xmlns="http://www.w3.org/2000/svg" width="2" height="16" viewBox="0 0 2 16" fill="none">
                        <path d="M1 0.5V16" stroke="black"/></svg></span>
                    <li> <a href="<?php echo e(route('cart')); ?>" class="tfu-active" style="font-weight:800;">Cart</a></li>
                    <span><svg xmlns="http://www.w3.org/2000/svg" width="2" height="16" viewBox="0 0 2 16" fill="none">
                        <path d="M1 0.5V16" stroke="black"/></svg></span>
                </ul>
               ...
               <table class="table table-borderless">
                    <tbody>
                            ...
                            <?php $__currentLoopData = $cart_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr id="tr_<?php echo e($cart_product->cid); ?>" class="cart_tr">
                                    <td class="align-middle tfu-cart-whislist-remove-mr">
                                        ...
                                        <a href="javascript:void(0)" class="cart_whishlist_product_btn tfu_add_wish_list <?php echo e($alreadyInWishlist ? 'already_wish_list' : ''); ?>" data-pid="<?php echo e($cart_product->pid); ?>"  rel="nofollow">
                                        ...
                                        <a href="javascript:void(0)" class="cart_remove_product_btn" data-cid="<?php echo e($cart_product->cid); ?>"  rel="nofollow">
                                    ...
                                    <td class="align-middle" >
                                        <div class="tfu-img-cart" >
                                            <?php if( !empty($cart_product->feature_image) && \Storage::disk('uploads')->exists('/products/small-'.$cart_product->feature_image)): ?>
                                                <img src="<?php echo e(url('uploads/products/small-'.$cart_product->feature_image)); ?>" alt="cart-remove-product.svg" />
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                      <div class="tfu-cart-menu-product-info" >
                                        <a href="<?php echo e(route('product-detail',['slug' => $cart_product->product_slug ])); ?>"><h2><?php echo $cart_product->product_name; ?></h2></a>
                                        <a href="<?php echo e(route('artist-detail',['slug' => $cart_product->artist_slug ])); ?>"><h3><?php echo $cart_product->display_name; ?></h3></a>
                                          <div class="tfu-mr-cart-info" >
                                            <p><?php echo $cart_product->type_name; ?></p>
                                            <p><?php echo e($cart_product->product_sku); ?></p>
                                          </div>
                                      </div>
                                    </td>
                                    ...
                                    <td class="align-middle tfu-mr-cart" >
                                      <div class="tfu-cart-product-price" >
                                          <h2><span>$</span><?php echo e($cart_product->price); ?></h2>
                                          <span> <?php echo e((isset($site_management->msrp_price) && $site_management->msrp_price > 0 ) ? 'MSRP $'.number_format(ceil($site_management->msrp_price * $cart_product->price),2)  : ''); ?></span>
                                     </div>
                                    </td>
                                          ...
                                          <div class="tfu-wrapper-shop-select" >
                                              <div class="ftu-wrapper-select-quantity">
                                                  ...
                                                  <div class="ftu-select-btn-qty">
                                                      <span data-qty="<?php echo e($cart_product->quantity); ?>"><?php echo e($cart_product->quantity); ?>  ($<?php echo e($cart_product->price * $cart_product->quantity); ?>)</span>
                                                  ...
                                                  <div class="ftu-select-content-qty">
                                                      ...
                                                      <ul class="ftu-qty-options" id="qty_ul_<?php echo e($cart_product->cid); ?>" data-cid="<?php echo e($cart_product->cid); ?>">
                                                          <?php
                                                      ...
                                                      <div class="ftu-qty-input">
                                                            <input data-moq="<?php echo e($p_quantity); ?>" data-cp="<?php echo e($moq_case_pack->case_pack); ?>"  data-price="<?php echo e($cart_product->price); ?>" class="ftu-product-quantity numeric_only" type="text" placeholder="Custom quantity">
                                    ...
                                    <td class="align-middle tfu-mr-cart " >
                                        <a href="javascript:void(0)"  rel="nofollow" class="cart_remove_product_btn" data-cid="<?php echo e($cart_product->cid); ?>">
                                            <div class="cart-remove-product">
                                                <img  src="<?php echo e(asset('/assets/frontend-assets/svg/cart-remove-product.svg')); ?>" alt="cart-remove-product.svg" />
                                            </div>
                                        </a>
                                    ...
                                    <td class="align-middle tfu-mr-cart" >
                                        ...
                                        <?php
                                            ...
                                            if($alreadyInWishlist)
                                                $wishlist_icon_name = 'whishlist-heart.svg';
                                        ?>
                                        <a href="javascript:void(0)"  rel="nofollow" class="cart_whishlist_product_btn tfu_add_wish_list <?php echo e($alreadyInWishlist ? 'already_wish_list' : ''); ?>" data-pid="<?php echo e($cart_product->pid); ?>">
                                            <div class="cart-whishlist-product">
                                                <img src="<?php echo e(asset('/assets/frontend-assets/svg/'.$wishlist_icon_name)); ?>" alt="<?php echo e($wishlist_icon_name); ?>">
                                            </div>
                                        </a>
            ...
            <div class="tfu-cart-item-btn" >
              <a href="<?php echo e(route('frontend.products')); ?>">Add more items</a>
            </div>
            ...
            <section class="table table-borderless tfu-total-cart-table">
                <div class="row">
                    <?php if(empty($is_customer->shiping_address1) && empty($is_customer->shiping_address2)): ?>
                        <div class="col-md-4"></div>
                        <div class="col-md-8">
                            <div class="ftu-mb-input text-center e_shopping_address">
                                <b>Please add your address before placing the order. Click <a href="<?php echo e(route('customer-profile')); ?>" class="ftu-common-btn" style="margin-left: 10px;">Edit Profile</a> to update.</b>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2" >
                           <a href="<?php echo e(route('customer-profile')); ?>" class="ftu-common-btn" style="margin-left: 10px;">Edit Address</a>
                        </div>
                    <?php endif; ?>
                    <div class="col-md-2"></div>
                    <div class="col-md-10">
                    ...
                    <div class="col-md-10">
                        ...
                        ?>
                          ...
                          <tr>
                            <td>
                             <div class="tfu-cart-shipping-detils ">
                               ...
                               <h6>Expected ship date <?php echo e(date('m/d/Y', strtotime($estimated_ship_date))); ?></h6>
                             </div>
                            </td>
                            ...
                            <td>
                                <div class="cart-shipping-price tfu-pricing" id="shipment_cost">
                                    <?php if($cart_total_price <= $site_management->shipping_threshold): ?>
                                        <?php
                                            $shipment_cost = $site_management->shipping_fee;
                                        ?>
                                        $<?php echo e(number_format($shipment_cost, 2)); ?>
                          ...
                          <tr>
                            ...
                            <td><div class="cart-shipping-price tfu-pricing" id="final_price">$<?php echo e(number_format($cart_total_price + $shipment_cost, 2)); ?></div></td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="tfu-cart-check-handle">
                               ...
                               <?php if((isset($site_management->minimum_order_amount) && $site_management->minimum_order_amount > $cart_total_price )): ?>
                                    <button type="submit" class="ftu-cart-order-submit disabled" id="">Minimum order size $<?php echo e($site_management->minimum_order_amount); ?></button>
                               <?php else: ?>
    ...
    <section class="ftu-cart-menu-wrapper">
        ...
        <div class="tfu-cart-empty">
             <div class="tfu-cart-empty-left" ><a href="<?php echo e(route('frontend.products')); ?>">
                <img  src="<?php echo e(asset('/assets/frontend-assets/svg/left-chevron-icon.svg')); ?>" alt="left-chevron-icon.svg" /> </a>
             </div>
              <p><span><img src="<?php echo e(asset('/assets/frontend-assets/svg/empty-cart-icon.svg')); ?>" alt="empty-cart-icon.svg" />
        ...
        $(document).ready(function () {
            ...
            function update_cart(cid, quantity) {
                $.ajax({
                    ...
                    type: "POST",
                    data: { cid: cid ,quantity: quantity, "_token": "<?php echo e(csrf_token()); ?>"},
                    success: function(response) {
                        if(response.status == 'success') {
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/frontend/shop/cart.blade.php ENDPATH**/ ?>