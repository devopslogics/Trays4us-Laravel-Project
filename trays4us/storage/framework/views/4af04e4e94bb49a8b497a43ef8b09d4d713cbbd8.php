...
" >
    <?php for($i = 0; $i<32; $i++): ?>
        <img src="<?php echo e($sourcePath); ?>" alt="Artist Logo" style="width: 1240px;  height: 1240px;  display: inline-block;   box-shadow: none;
...
">
    <?php for($i = 0; $i < 32; $i++): ?>
        <div style="width: 450px; height: 450px; transform: rotate(180deg); margin: 454.5px 453px 454.5px 455px; display: inline-block; position: relative;">
            <img src="<?php echo e($customer_logo); ?>" style="max-width: 100%; max-height: 100%; object-fit: contain; vertical-align: middle; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
        </div>
    <?php endfor; ?>
</div>
...
<?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/admin/products/custom-product-pdf-4x4.blade.php ENDPATH**/ ?>