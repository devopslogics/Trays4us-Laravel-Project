        ...
        <div class="col-xl-12">
            ...
            <div class="card">
               ...
               <form action="" method="post" enctype="multipart/form-data" class="ftu-form-user-uploaded dropzone" id="homepage_slider_save">
                   ...
                   <div class="row">
                       <input type="hidden" name="id" id="slider_id" value="<?php echo e($homepage_slider->id); ?>">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-auto">
                                   <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="slider_direction" id="left" value="start" <?php echo e($homepage_slider->slider_direction == "start" ? 'checked' : ''); ?>>
                                       <label class="form-check-label" for="left">Left</label>
                                   </div>
                                   <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="slider_direction" id="centered" value="center" <?php echo e($homepage_slider->slider_direction == "center" ? 'checked' : ''); ?>>
                                       <label class="form-check-label" for="centered">Centered</label>
                                   </div>
                                   <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="slider_direction" id="right" value="end" <?php echo e($homepage_slider->slider_direction == "end" ? 'checked' : ''); ?>>
                           ...
                           <div class="row">
                               <div class="col-md-2">
                                   <div class="form-group" >
                                       ...
                                       <input class="form-control" type="text" name="title_size" id="title_size" value="<?php echo e($homepage_slider->title_size); ?>">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-2">
                                   <div class="form-group" style="position:relative;">
                                       ...
                                       <input class="form-control" type="text" name="title_color" id="title_color" value="<?php echo e($homepage_slider->title_color); ?>">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-2">
                                   <div class="form-group" style="position:relative;">
                                       ...
                                       <input class="form-control" type="text" name="title_box_color" id="title_box_color" value="<?php echo e($homepage_slider->title_box_color); ?>">
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="col-md-5">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="slider_title" id="slider_title" value="<?php echo e($homepage_slider->slider_title); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-4">
                           <div class="form-group">
                               <label>Link</label>
                               <input class="form-control" type="text" name="slider_title_link" id="slider_title_link" value="<?php echo e($homepage_slider->slider_title_link); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-3">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="checkbox" name="slider_title_visibility" id="slider_title_visibility" value="0" <?php echo e($homepage_slider->slider_title_visibility == 0 ? 'checked' : ''); ?>>
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="shop_btn_text" id="shop_btn_text" value="<?php echo e($homepage_slider->shop_btn_text); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               <label>Link</label>
                               <input class="form-control" type="text" name="shop_now_link" id="shop_now_link" value="<?php echo e($homepage_slider->shop_now_link); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-12">
                           <div class="row">
                               <div class="col-md-2">
                                   <div class="form-group">
                                       <label>Text Size</label>
                                       <input class="form-control" type="text" name="label_text_size" id="label_text_size" value="<?php echo e($homepage_slider->label_text_size); ?>">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-2">
                                   <div class="form-group" style="position:relative;">
                                       <label>Text Color #</label>
                                       <input class="form-control" type="text" name="label_color" id="label_color" value="<?php echo e($homepage_slider->label_color); ?>">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-2">
                                   <div class="form-group" style="position:relative;">
                                       <label>Text Box and its #</label>
                                       <input class="form-control" type="text" name="label_box_color" id="label_box_color" value="<?php echo e($homepage_slider->label_box_color); ?>">
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="first_label" id="first_label" value="<?php echo e($homepage_slider->first_label); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="url" name="first_link" id="first_link" value="<?php echo e($homepage_slider->first_link); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="second_label" id="second_label" value="<?php echo e($homepage_slider->second_label); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="url" name="second_link" id="second_link" value="<?php echo e($homepage_slider->second_link); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="third_label" id="third_label" value="<?php echo e($homepage_slider->third_label); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="url" name="third_link" id="third_link" value="<?php echo e($homepage_slider->third_link); ?>">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="url" name="entire_banner_link" id="entire_banner_link" value="<?php echo e($homepage_slider->entire_banner_link); ?>">
                           </div>
                       </div>
                    ...
                    <div class="mt-4">
                        <button class="btn btn-primary" type="submit" id="homepageslider_btn">Update</button>
    ...
    <script>
        ...
        $(function() {
            ...
            var myDropzone = new Dropzone("#dropzoneDragArea", {
                ...
                url: "<?php echo e(route('edit-homepage-slider-submitted')); ?>",
                ...
                init: function() {
                    ...
                    var myDropzone = this;
                    var mockFile = { name: "<?php echo e($homepage_slider->slider_image); ?>", size: 12345, url : "<?php echo e(url('uploads/sliders/'.$homepage_slider->slider_image)); ?>" , id : "<?php echo e($homepage_slider->id); ?>" }; // You might need to adjust the size
                    myDropzone.emit("addedfile", mockFile);
                    myDropzone.emit("addFile", mockFile);
                    myDropzone.emit("thumbnail", mockFile, "<?php echo e(url('uploads/sliders/'.$homepage_slider->slider_image)); ?>");
...
<?php echo $__env->make('layouts.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.trays4.us/public_html/resources/views/admin/homepage_slider/edit.blade.php ENDPATH**/ ?>