<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click",".tfu_add_wish_list_popup",function() {
            var popup_html = `<div class="tfu-popup-useraccount">
                            ...
                            <p>New account? <span><a href="{{ route('sign-up') }}">Start here</a></span></p>
                        </div>`;
        ...
        $(document).on("click",".tfu_add_wish_list",function() {
            ...
            $.ajax({
                ...
                type: "POST",
                data: { productId: productId,already_wish_list : already_wish_list , "_token": "{{ csrf_token() }}"},
    ...
    @if(App::environment('production') && !Session::has('is_customer'))
        var show_msg = 0;
        var options = '';
