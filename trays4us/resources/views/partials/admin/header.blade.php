 <div class="header">
	<div class="header-left">
	   ...
	   <img src="{{ asset('/assets/images/logo-icon.png')}}" alt="Logo" width="30" height="30">
	   </a>
	</div>
	...
	<ul class="nav user-menu">
	   ...
	   <li class="nav-item dropdown">
		  <a href="javascript:void(0)"  rel="nofollow" class="dropdown-toggle user-link  nav-link" data-bs-toggle="dropdown">
		    ...
		    <span class="user-img">
                @if( !empty($is_admin->photo) && \Storage::disk('uploads')->exists('/users/'.$is_admin->photo))
                    <img src="{{ url('uploads/users/'.$is_admin->photo) }}" class="fav-icon" alt>
                @else
                        <img class="rounded-circle" src="{{ asset('/assets/img/user-avatar.png')}}" width="40" alt="Admin">
                @endif
