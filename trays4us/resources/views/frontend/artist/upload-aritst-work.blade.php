...
@section('content')
    ...
    <section class="tfu-license-artwork-wrapper">
        <div class="container-fluid p-0">
            ...
            <form action="{{ route('save-artist-work') }}" method="post" enctype="multipart/form-data" name="add_artist_work" id="add_artist_work" class="dropzone" onsubmit="return false;">
                    ...
                    <div class="col-12 col-lg-8 artwork_gallery p-0 overflow-hidden position-relative">
                        ...
                        <div id="dropzoneDragArea" class="dz-default dz-message dropzoneDragArea">
                            ...
                            <div class="artist_gallery d-flex flex-wrap justify-content-center align-items-center">
                                <div id="upload_image">
                                    <img src="{{ asset('/assets/images/T4Us_Blank_Front_5.png') }}" alt="">
                                    <img src="{{ asset('/assets/images/T4Us_Blank_Front_6.png') }}" alt="">
                                    <img src="{{ asset('/assets/images/T4Us_Blank_Front_2.png') }}" alt="">
                                    <img src="{{ asset('/assets/images/T4Us_Blank_Front_1.png') }}" alt="">
                                    <img src="{{ asset('/assets/images/T4Us_Blank_Front_3.png') }}" alt="">
                                </div>
                    ...
                    <div class="col-12 col-lg-3 artist_logo p-0 overflow-hidden position-relative">
                        ...
                        <div id="logo_image_area" class="dz-default dz-message dropzoneDragArea">
                            ...
                            <div class="artist_logo_img text-center">
                                <div id="upload_logo">
                                    @if( !empty($is_customer->customer_logo) && \Storage::disk('uploads')->exists('/users/' .$is_customer->customer_logo))
                                        <img src="{{ url('uploads/users/'.$is_customer->customer_logo) }}" alt="" data-logo="1" class="w-100">
                                    @else
                                        <img src="{{ asset('/assets/images/T4Us_Blank_Back_4.png') }}" alt="" data-logo="0" class="w-100">
                                    @endif
                                </div>
                    ...
                    <div class="col-12 col-lg-8 artwork-images_sizes_section p-2">
                        ...
                        <div class="row d-flex  justify-content-md-start  justify-content-evenly tfu-upload-wrap" >
                                        ...
                                        @foreach($product_types as $product_type)
                                            @foreach($product_type->child_types_having_criteria as $childType)
                                                <div class="chexbox-artist  position-relative">
                                                    <input type="checkbox" name="product_types[]" value="{{$childType->id}}" class="tfu_product_ids position-relative">
                                                    <label for="checkbox" class="position-absolute"></label>
                                                    <p class="m-0 p-0 d-flex gap-0 text-black image-resolutions-p"><span class="tfu-image-sku-type" >{{$childType->type_name}} {{$product_type->type_name}}</span><span class="tfu-image-resolutions" data-width="{{$childType->width}}" data-height="{{$childType->height}}">{{$childType->width}} x {{$childType->height}} px</span> </p>
                                                </div>
                                            @endforeach
                                        @endforeach
                                    @endif
                            ...
                            <div class="col-12 col-md-4  col-lg-4 back_logo p-lg-0">
                                ...
                                <img src="{{ asset('/assets/images/back_logo.png') }}" alt="">
            ...
            var logoDropzone = new Dropzone("#logo_image_area", {
                ...
                init: function() {
                    ...
                    @if( !empty($is_customer->customer_logo) && \Storage::disk('uploads')->exists('/users/' .$is_customer->customer_logo))
                        ...
                        var existingFile = "{{ url('uploads/users/'.$is_customer->customer_logo) }}"; // Replace with actual path to the uploaded logo file
                        if (existingFile) {
                    ...
                    this.on("removedfile", function (file) {
                        ...
                        if(is_customer_logo) {
                            $('#upload_logo img').attr("src","{{ asset('/assets/images/T4Us_Blank_Back_4.png') }}");
                        }
