                ...
                <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 tfu-c-tray" >
                    <div class="tfu-inner-custom-product" >
                        ...
                        <div class="tfu-inner-custom-image" >
                            ...
                            <a href="{{ route('license-artwork') }}/custom-item"> <img src="{{ asset('/assets/frontend-assets/images/round-tray.png') }}" alt="round-tray.png"  /></a>
                ...
                <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2  tfu-c-tray"  >
                    ...
                    <div class="tfu-inner-custom-product" >
                        ...
                        <div class="tfu-inner-custom-image" >
                            ...
                            <a href="{{ route('license-artwork') }}/custom-item"><img src="{{ asset('/assets/frontend-assets/images/1612-rectangle-tray.png') }}" alt="1612-rectangle-tray.png" /></a>
                ...
                <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 tfu-c-tray"  >
                    ...
                    <div class="tfu-inner-custom-product" >
                        ...
                        <div class="tfu-inner-custom-image" >
                            ...
                            <a href="{{ route('license-artwork') }}/custom-item"><img src="{{ asset('/assets/frontend-assets/images/1108-rectangle-tray.png') }}"  alt="1108-rectangle-tray.png"/></a>
                ...
                <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 tfu-c-tray"  >
                    ...
                    <div class="tfu-inner-custom-product" >
                        ...
                        <div class="tfu-inner-custom-image" >
                            ...
                            <a href="{{ route('license-artwork') }}/custom-item"><img src="{{ asset('/assets/frontend-assets/images/1105-rectangle-tray.png') }}"  alt="1105-rectangle-tray.png"/></a>
                ...
                <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 tfu-c-tray"   >
                    ...
                    <div class="tfu-inner-custom-product" >
                        ...
                        <div class="tfu-inner-custom-image" >
                            ...
                            <a href="{{ route('license-artwork') }}/custom-item"><img src="{{ asset('/assets/frontend-assets/images/f8b2eb8a59003208d6d740726bb47068.png') }}"  alt="f8b2eb8a59003208d6d740726bb47068.png"/></a>
        ...
        <div class="row" >
         ...
         <div class="tfu-create-custom-content-wrapper" >
            ...
            <div class="tfu-create-custom-information" >
              ...
              <a class="ftu-common-btn"  href="{{ route('license-artwork') }}/custom-item">Order Custom</a>
           ...
           <div class="tfu-create-custom-img-requirement" >
             ...
             <a class="ftu-common-btn"  href="{{ route('home') }}/term-condition">Terms & conditions</a>
