        ...
        <div class="col-xl-12">
            ...
            <div class="card">
               ...
               <form action="" method="post" enctype="multipart/form-data" class="ftu-form-user-uploaded dropzone" id="homepage_slider_save">
                    {{ csrf_field() }}
                   <div class="row">
                       <input type="hidden" name="id" id="slider_id" value="{{$homepage_slider->id}}">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-auto">
                                   <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="slider_direction" id="left" value="start" {{ $homepage_slider->slider_direction == "start" ? 'checked' : '' }}>
                                       <label class="form-check-label" for="left">Left</label>
                                   </div>
                                   <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="slider_direction" id="centered" value="center" {{ $homepage_slider->slider_direction == "center" ? 'checked' : '' }}>
                                       <label class="form-check-label" for="centered">Centered</label>
                                   </div>
                                   <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="slider_direction" id="right" value="end" {{ $homepage_slider->slider_direction == "end" ? 'checked' : '' }}>
                           ...
                           <div class="row">
                               <div class="col-md-2">
                                   <div class="form-group" >
                                       ...
                                       <input class="form-control" type="text" name="title_size" id="title_size" value="{{ $homepage_slider->title_size }}">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-2">
                                   <div class="form-group" style="position:relative;">
                                       ...
                                       <input class="form-control" type="text" name="title_color" id="title_color" value="{{ $homepage_slider->title_color }}">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-2">
                                   <div class="form-group" style="position:relative;">
                                       ...
                                       <input class="form-control" type="text" name="title_box_color" id="title_box_color" value="{{ $homepage_slider->title_box_color }}">
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="col-md-5">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="slider_title" id="slider_title" value="{{ $homepage_slider->slider_title }}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-4">
                           <div class="form-group">
                               <label>Link</label>
                               <input class="form-control" type="text" name="slider_title_link" id="slider_title_link" value="{{ $homepage_slider->slider_title_link }}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-3">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="checkbox" name="slider_title_visibility" id="slider_title_visibility" value="0" {{ $homepage_slider->slider_title_visibility == 0 ? 'checked' : '' }}>
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="shop_btn_text" id="shop_btn_text" value="{{$homepage_slider->shop_btn_text}}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               <label>Link</label>
                               <input class="form-control" type="text" name="shop_now_link" id="shop_now_link" value="{{ $homepage_slider->shop_now_link }}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-12">
                           <div class="row">
                               <div class="col-md-2">
                                   <div class="form-group">
                                       <label>Text Size</label>
                                       <input class="form-control" type="text" name="label_text_size" id="label_text_size" value="{{ $homepage_slider->label_text_size }}">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-2">
                                   <div class="form-group" style="position:relative;">
                                       <label>Text Color #</label>
                                       <input class="form-control" type="text" name="label_color" id="label_color" value="{{ $homepage_slider->label_color }}">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-2">
                                   <div class="form-group" style="position:relative;">
                                       <label>Text Box and its #</label>
                                       <input class="form-control" type="text" name="label_box_color" id="label_box_color" value="{{ $homepage_slider->label_box_color }}">
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="first_label" id="first_label" value="{{$homepage_slider->first_label}}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="url" name="first_link" id="first_link" value="{{$homepage_slider->first_link}}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="second_label" id="second_label" value="{{$homepage_slider->second_label}}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="url" name="second_link" id="second_link" value="{{$homepage_slider->second_link}}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="third_label" id="third_label" value="{{$homepage_slider->third_label}}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="url" name="third_link" id="third_link" value="{{$homepage_slider->third_link}}">
                           </div>
                       </div>
                       ...
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input class="form-control" type="url" name="entire_banner_link" id="entire_banner_link" value="{{$homepage_slider->entire_banner_link}}">
                           </div>
                       </div>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('homepage-slider') }}" class="btn btn-link">Cancel</a>
                    </div>
                 </form>
    ...
    <script>
        ...
        $(function() {
            ...
            var myDropzone = new Dropzone("#dropzoneDragArea", {
                ...
                url: "{{ route('edit-homepage-slider-submitted') }}",
                ...
                init: function() {
                    ...
                    var myDropzone = this;
                    var mockFile = { name: "{{ $homepage_slider->slider_image }}", size: 12345, url : "{{ url('uploads/sliders/'.$homepage_slider->slider_image) }}" , id : "{{ $homepage_slider->id }}" }; // You might need to adjust the size
                    myDropzone.emit("addedfile", mockFile);
                    myDropzone.emit("addFile", mockFile);
                    myDropzone.emit("thumbnail", mockFile, "{{ url('uploads/sliders/'.$homepage_slider->slider_image) }}");
