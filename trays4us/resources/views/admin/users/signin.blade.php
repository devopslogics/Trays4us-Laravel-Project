                  ...
                  <div class="login-right-wrap">
                     ...
                     <form action="<?php echo route('admin_submitted'); ?>" class="" method="post" id="login-form">
                        ...
                        <div class="form-group">
                           ...
                           <input class="form-control" type="text" placeholder="Enter your email" id="email" name="email" value="{{old('email')}}">
                        </div>
                        <div class="form-group mb-4">
                           <label class="control-label">Password</label>
                           <input class="form-control" type="password" placeholder="Enter your password" name="password" id="password" value="{{old('password')}}">
                        </div>
