        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('bulk-tag-manager-submitted') }}" method="post" enctype="multipart/form-data" name="add_product" id="add_product_form" class="add_product">
                        {{ csrf_field() }}
        ...
        $(document).ready(function () {
            ...
            $("#product-input").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "{{ route('get-products-by-autocomplete') }}",  // Replace with your actual server endpoint
                        type: "GET",
                        dataType: "json",
                        data: {
                            query: request.term,
