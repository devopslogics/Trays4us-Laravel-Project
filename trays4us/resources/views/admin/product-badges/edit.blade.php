    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Edit Badge</h3>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('edit-badge-submitted') }}" method="post" enctype="multipart/form-data" class="edit-badge-submitted">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="badge" value="{{$badge->badge}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                        ...
                                        <input id="cp1" type="text" class="form-control" name="color" value="{{$badge->color}}"/>
                                </div>
                            </div>
                        </div>
